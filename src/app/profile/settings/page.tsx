    ...
    <Section ariaLabel="Profile Settings" className="py-8" id="profile-settings">
      <Container>
        ...
        <div className="mx-auto max-w-4xl space-y-12">
          <CardBorder className="items-start border-gold bg-background/50 p-8">
            ...
            <div className="grid w-full grid-cols-1 gap-6 md:grid-cols-2">
              <div className="space-y-1.5">
                ...
                <Input className="border-gold" defaultValue="CurrentUsername" id="username" name="username" type="text" />
              </div>
              <div className="space-y-1.5">
                <label className="text-sm font-medium text-foreground/80" htmlFor="email">
                  Email Address
                </label>
                <Input className="border-gold" defaultValue="user@example.com" id="email" name="email" type="email" />
              </div>
            </div>
          </CardBorder>
          ...
          <CardBorder className="items-start border-gold bg-background/50 p-8">
            ...
            <div className="w-full space-y-6">
              <div className="space-y-1.5">
                ...
                <Input className="border-gold" id="current-password" name="current-password" placeholder="••••••••" type="password" />
              </div>
              <div className="space-y-1.5">
                <label className="text-sm font-medium text-foreground/80" htmlFor="new-password">
                  New Password
                </label>
                <Input className="border-gold" id="new-password" name="new-password" placeholder="••••••••" type="password" />
              </div>
              <div className="space-y-1.5">
                <label className="text-sm font-medium text-foreground/80" htmlFor="confirm-password">
                  Confirm New Password
                </label>
                <Input className="border-gold" id="confirm-password" name="confirm-password" placeholder="••••••••" type="password" />
              </div>
            </div>
          </CardBorder>

          <div className="flex justify-end">
            <Button className="border-gold font-bold text-foreground transition-colors hover:bg-gold hover:text-background" size="lg" variant="outline">
              Save Changes
            </Button>
          </div>
        </div>
